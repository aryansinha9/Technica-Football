    ...
    <>
      ...
      <section className="relative bg-white text-[#0A1F44] pt-0 pb-35 px-8 md:px-16">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#f0722b] rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <div className="p-8">
              <h3 className="text-2xl font-black mb-3 text-white">Fun and Engaging</h3>
              <p className="text-white/85 leading-relaxed whitespace-pre-wrap">
                Our programs are built on enjoyment and engagement. Every session is designed to keep kids active, smiling, and eager to participate through exciting game-based activities.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#f0722b] rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <div className="p-8">
              <h3 className="text-2xl font-black mb-3 text-white">Professional Coaching</h3>
              <p className="text-white/85 leading-relaxed whitespace-pre-wrap">
                Qualified teachers and experienced coaches. All coaches hold valid WWCC accreditation and First Aid training.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ─── Program Information ─── */}
      <section className="relative bg-[#0A1F44] text-white pt-4 pb-39 px-8 md:px-16">
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] z-10 pointer-events-none -translate-y-[99%]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 235 1440 85" preserveAspectRatio="none" className="block w-full h-[40px] md:h-[70px] lg:h-[100px]">
      ...
      {/* ─── Interest Form ─── */}
      <section className="relative bg-[#f3f4f6] text-[#0A1F44] pt-5 pb-24 px-8 md:px-16">
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] z-10 pointer-events-none -translate-y-[99%]">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
              ...
              <div>
                <label htmlFor="additionalInfo" className="block text-sm font-semibold text-gray-700 mb-1.5 font-barlow tracking-wide uppercase">Additional Information (Optional)</label>
                <textarea id="additionalInfo" name="additionalInfo" rows={3} onChange={handleChange} placeholder="Any other details we should know?" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#0A1F44] focus:ring-2 focus:ring-[#0A1F44]/10 outline-none transition-all text-[#0A1F44] resize-y" />
              </div>
