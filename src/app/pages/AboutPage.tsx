...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* Mission Section */}
      <section className="relative bg-[#f3f4f6] text-[#0A1F44] pt-24 pb-45 px-8 md:px-16">
      ...
      <section className="relative bg-[#21211f] text-white pt-16 pb-50 px-8 md:px-16">
      ...
      {/* Values Section */}
      <section className="relative bg-[#0A1F44] text-white pt-18 pb-45 px-8 md:px-16">
      ...
      <section className="relative bg-[#f0722b] text-white py-16 px-8 md:px-16">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-6 text-center md:text-left">
          <ShieldCheck className="w-14 h-14 shrink-0" />
          <p className="font-barlow font-bold text-xl md:text-2xl lg:text-3xl tracking-wide uppercase leading-tight">
