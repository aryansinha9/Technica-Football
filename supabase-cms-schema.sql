...
INSERT INTO programs (id, icon, label, title, ages, href, description, visible, sort_order) VALUES
  ...
  ('club-technica-training', 'Users', 'Community', 'Club Technica Training', 'Ages 5–15', '/programs/club-technica-training', 'Train with the Technica Football community. Group sessions focused on technical development, teamwork, and building the club culture that drives players to excel.', true, 3),
  ('academy-development-squad', 'Trophy', 'Elite Pathway', 'Academy Development Squad', 'Ages 8–16', '/programs/academy-development-squad', 'An elite development pathway for players who are serious about reaching the next level. High-performance sessions covering advanced technique, tactical intelligence, and physical conditioning.', true, 4),
  ('holiday-clinic', 'Sun', 'Holiday', 'Holiday Clinic', 'Ages 5–15', '/programs/holiday-clinic', 'Intensive multi-day camps during school holidays. A fantastic opportunity for players to develop skills, build new friendships, and keep active throughout the break.', true, 5),
